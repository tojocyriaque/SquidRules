...
<NAV class="navbar navbar-expand-xl navbar-dark bg-dark text-white">
	<DIV class="container-fluid">
		<DIV class="col-md-6">
			<UL class="navbar-nav">
				<LI class="nav-item">
					<A class="nav-link active" href="http://www.devoir.com/index.php/acceuille">Dashboard</A>
				</LI>
				<LI class="nav-item">
		...
		<DIV class="col-md-6 d-flex justify-content-end">
			<FORM class="d-flex" action="http://www.devoir.com/index.php/LogProxy/list"  method=get>
